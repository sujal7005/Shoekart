...
const ProductForm = ({
  ...
  // In ProductForm.jsx, update the handleFileChange function
  const handleFileChange = async (event) => {
    ...
    try {
      const apiKey = import.meta.env.VITE_REACT_APP_REMOVEBG_KEY;
      if (!apiKey) {
        console.warn("Remove.bg API key not found");
        // Upload directly to Cloudinary without removing background
